...
public class OrdersApiDetailsMapper {
    ...
    public OrdersApiDetailsMapper(DateGenerator dateGenerator,
            ...
            @Qualifier("snakeCaseMapper") ObjectMapper objectMapper,
    ...
    /**
     * Delegates mapping of ordersApiWrappable to OrderNotificationEmailData to the director and then builds an EmailSend object
     * from the emailData and email configuration properties.
     *
    ...
    /**
     * Delegates mapping of ordersApiWrappable to OrderNotificationEmailData to the director and then builds an EmailSend object
     * from the emailData, the email configuration properties and the incoming item ready notification.
     *
     * @param ordersApiWrappable    A wrapper interface for an OrdersApi object
     * @param itemReadyNotification the incoming item ready notification
     * @return EmailSend
     */
    public EmailSend mapToEmailSend(final OrdersApiWrappable ordersApiWrappable,
            final ItemGroupProcessedSend itemReadyNotification) {
        OrderNotificationDataConvertable converter = factory.newConverter(itemReadyNotification, itemReadyEmailConfig);
        mapDirector(ordersApiWrappable, converter);
        try {
    ...
    private void mapDirector(final OrdersApiWrappable ordersApiWrappable, final OrderNotificationDataConvertable converter) {
