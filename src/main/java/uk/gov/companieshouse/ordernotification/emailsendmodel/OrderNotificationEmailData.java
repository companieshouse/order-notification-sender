...
public class OrderNotificationEmailData {
    ...
    public boolean equals(Object o) {
        ...
        return hasStandardDelivery == that.hasStandardDelivery && hasExpressDelivery == that.hasExpressDelivery
                && dispatchDays == that.dispatchDays && Objects.equals(to, that.to) && Objects.equals(subject, that.subject)
                && Objects.equals(orderId, that.orderId) && Objects.equals(certificates, that.certificates) && Objects.equals(
                certifiedCopies, that.certifiedCopies) && Objects.equals(missingImageDeliveries, that.missingImageDeliveries)
                && Objects.equals(deliveryDetails, that.deliveryDetails) && Objects.equals(paymentDetails, that.paymentDetails)
                && Objects.equals(orderSummaryLink, that.orderSummaryLink);
    }

    @Override
    public int hashCode() {
        return Objects.hash(to, subject, orderId, certificates, certifiedCopies, missingImageDeliveries, deliveryDetails,
                paymentDetails, hasStandardDelivery, hasExpressDelivery, orderSummaryLink, dispatchDays);
    }
}
