...
public class ErrorHandlingService {
    ...
    @Autowired
    public ErrorHandlingService(MessageProducer messageProducer, LoggingUtils loggingUtils,
            @Value("${maximum.retries}") int maxRetries) {
    ...
    /**
     * Handles errors raised when processing order notifications. If the number of configured retries has been exceeded, a message
     * will be published to the error topic, otherwise a message will be sent to the retry topic.
     *
