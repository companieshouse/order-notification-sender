...
class FilingHistoryDescriptionProviderServiceTest {
    ...
    void mapFilingHistoryDescriptionGetsDescriptionAndReplacesVariables() {
        final FilingHistoryDescriptionProviderService provider = new FilingHistoryDescriptionProviderService(
                TestConstants.DESCRIPTION_FILE, new LoggingUtils(LoggerFactory.getLogger(APPLICATION_NAMESPACE)),
                TestConstants.EMAIL_DATE_FORMAT);
        assertThat(provider.mapFilingHistoryDescription(TestConstants.DESCRIPTION_KEY, DESCRIPTION_VALUES),
                is(TestConstants.EXPECTED_DESCRIPTION));
    }
    ...
    void mapFilingHistoryDescriptionGetsDescriptionAndReturnsDescriptionInDescriptionValue() {
        final FilingHistoryDescriptionProviderService provider = new FilingHistoryDescriptionProviderService(
                TestConstants.DESCRIPTION_FILE, new LoggingUtils(LoggerFactory.getLogger(APPLICATION_NAMESPACE)),
                TestConstants.EMAIL_DATE_FORMAT);
        assertThat(provider.mapFilingHistoryDescription(TestConstants.DESCRIPTION_KEY_LEGACY, DESCRIPTION_VALUES_LEGACY),
                is(TestConstants.EXPECTED_DESCRIPTION_LEGACY));
    }
    ...
    void mapFilingHistoryDescriptionIgnoresDescriptionValuesThatAreNotStrings() {
        final FilingHistoryDescriptionProviderService provider = new FilingHistoryDescriptionProviderService(
                TestConstants.DESCRIPTION_FILE, new LoggingUtils(LoggerFactory.getLogger(APPLICATION_NAMESPACE)),
                TestConstants.EMAIL_DATE_FORMAT);
        assertThat(provider.mapFilingHistoryDescription(TestConstants.DESCRIPTION_KEY_ARRAY, DESCRIPTION_VALUES_ARRAY),
                is(TestConstants.EXPECTED_DESCRIPTION_ARRAY));
    }
    ...
    void mapFilingHistoryDescriptionReturnsDescriptionIfNoDescriptionValuesPresent() {
        final FilingHistoryDescriptionProviderService provider = new FilingHistoryDescriptionProviderService(
                TestConstants.DESCRIPTION_FILE, new LoggingUtils(LoggerFactory.getLogger(APPLICATION_NAMESPACE)),
                TestConstants.EMAIL_DATE_FORMAT);
        assertThat(provider.mapFilingHistoryDescription(TestConstants.DESCRIPTION_KEY_NULL, null),
                is(TestConstants.EXPECTED_DESCRIPTION_NULL));
    }
    ...
    void mapFilingHistoryDescriptionFileNotFoundReturnsNull() {
        final FilingHistoryDescriptionProviderService provider = new FilingHistoryDescriptionProviderService("notfound.yaml",
                new LoggingUtils(LoggerFactory.getLogger(APPLICATION_NAMESPACE)), TestConstants.EMAIL_DATE_FORMAT);
    ...
    void mapFilingHistoryDescriptionFileAbsentPropertyReturnsNull() {
        final FilingHistoryDescriptionProviderService provider = new FilingHistoryDescriptionProviderService("missing-key.yaml",
                new LoggingUtils(LoggerFactory.getLogger(APPLICATION_NAMESPACE)), TestConstants.EMAIL_DATE_FORMAT);
        assertNull(provider.mapFilingHistoryDescription(TestConstants.DESCRIPTION_KEY, DESCRIPTION_VALUES));
    }
